...
public class Stype extends Selement<TypeElement>{
    ...
    public static Stype of(TypeMirror mirror){
        return new Stype((TypeElement) FOSProcessor.typeu.asElement(mirror));
    }
    ...
    public Seq<Stype> superclasses(){
        return Seq.with(FOSProcessor.typeu.directSupertypes(mirror())).map(Stype::of);
    }
    ...
    public Stype superclass(){
        return new Stype((TypeElement) FOSProcessor.typeu.asElement(FOSProcessor.typeu.directSupertypes(mirror()).get(0)));
    }
