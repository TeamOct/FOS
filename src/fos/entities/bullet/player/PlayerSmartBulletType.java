...
import arc.Events;
import arc.util.*;
import fos.entities.bullet.SmartBulletType;
import mindustry.Vars;
import mindustry.entities.bullet.BulletType;
import mindustry.game.EventType;
import mindustry.gen.*;

public class PlayerSmartBulletType extends SmartBulletType {
    public PlayerSmartBulletType(float speed, float damage) {
        super(speed, damage);
    }
