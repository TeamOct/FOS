//lumina's generator
const lgen = extend(PlanetGenerator, {
    rawHeight(position){
    ...
    generate(tiles, sec){
        ...
        const Room = {
            ...
            connect(to){
                ...
                lgen.brush(lgen.pathfind(this.x, this.y, to.x, to.y, tile => (tile.solid() ? 5 : 0) + lgen.noiseOct(tile.x, tile.y, 1, 1, 1 / nscl) * 60, Astar.manhattan), stroke);
            }
        };
...
lgen.arr = [   
    [Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    
    [Blocks.stone, Blocks.dacite, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],
    [Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite],

    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.stone],
    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone],
    [Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.stone],
    [Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.dacite, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.dacite, Blocks.dacite, Blocks.dacite]
];
lgen.rid = new Packages.arc.util.noise.RidgedPerlin(1, 2);
lgen.basegen = new BaseGenerator();
lgen.scl = 5;
lgen.waterOffset = 0.07;
lgen.water = 2 / lgen.arr[0].length;

const lumina = new JavaAdapter(Planet, {}, "lumina", Planets.serpulo, 3, 0.6);
lumina.generator = lgen;
lumina.hasAtmosphere = false;
lumina.meshLoader = () => new HexMesh(lumina, 6);
lumina.startSector = 40;
